...
Currently, only the classic Blocks environment is available. To download it, visit the [GitHub releases section](https://github.com/ProjectAirSim/releases). . A City environment will be available soon! If you require another environment (e.g., urban, geo-specific, etc.), you can sponsor its maintenance by contacting [envs@iamaisim.com](mailto:envs@iamaisim.com).
